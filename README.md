...
| scrollViewProps     | ScrollViewProps                      | `{}`                                  | `ScrollViewIndicator` only. Props to pass to the underlying `ScrollView`. In particular, props `onLayout` and `onScroll` are allowed (_added in v0.4.0_). On the other hand, please do not pass the following props, as they will be overwritten and won't have any effect: `horizontal`, `showsVerticalScrollIndicator`, `showsHorizontalScrollIndicator`, `onContentSizeChange`, `scrollEventThrottle`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| flatListProps       | ScrollViewProps & FlatListProps<any> | **required**                          | `FlatListIndicator` only. Props to pass to the underlying `FlatList`. This is a required prop, as one must supply `data` and `renderItem` to `FlatList`. In particular, props `onLayout` and `onScroll` are allowed (_added in v0.4.0_). On the other hand, please do not pass the following props, as they will be overwritten and won't have any effect: `horizontal`, `showsVerticalScrollIndicator`, `showsHorizontalScrollIndicator`, `onContentSizeChange`, `scrollEventThrottle`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| containerStyle      | ViewStyle                            | `{}`                                  | Styling of the parent container that holds both the scroll indicator and the scrollable component. _added in v0.4.0_.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
